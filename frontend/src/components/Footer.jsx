    ...
    return (
        <footer className='max-padd-container mb-4'>
            <div className='max-padd-container bg-primary rounded-tr-3xl rounded-tl-3xl pt-12 xl:pt-20 pb-8'>
                <h3 className='h3'>Explore your options with us.</h3>
                <p>Do you enjoy the comfort of a new home ?</p>
                ...
                '>
                    <div className='max-w-sm'>
                        <Link to={'/'} className='flex items-center gap-x-2'>
                            <span className='font-[900] text-[24px]'>Gapribay<span className='font-[600] medium-20'>Homes</span></span>
                        </Link>
                        <p className='py-4'>Whether you're buying, renting, or investing, our expert team is here to guide you every step of the way
                        . Contact us today to begin your journey in real estate excellence</p>
            ...
            {/* copyrights */}
            <p className='text-white bg-tertiary medium-14 py-2 px-8 rounded-b-3xl flexBetween '><span>2024 Gapribay</span><span>All rights reserved</span></p>
        </footer>
    )
}
