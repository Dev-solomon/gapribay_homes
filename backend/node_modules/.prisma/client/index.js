...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/Dev-Solomon/Desktop/estate/backend/node_modules/@prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "mongodb+srv://ntiasolomon7:solomon@cluster0.u19sy66.mongodb.net/timothy"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = \"mongodb+srv://ntiasolomon7:solomon@cluster0.u19sy66.mongodb.net/timothy\"\n}\n\nmodel User {\n  id               String      @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name             String?\n  email            String      @unique\n  image            String?\n  isAdmin          Boolean     @default(false)\n  bookedVisits     Json[]\n  favResidenciesID String[]    @db.ObjectId\n  ownedResidencies Residency[] @relation(\"Owner\")\n}\n\nmodel Residency {\n  id          String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  title       String\n  description String\n  price       Int\n  address     String\n  city        String\n  country     String\n  image       String\n  facilities  Json\n  userEmail   String\n  owner       User     @relation(\"Owner\", fields: [userEmail], references: [email])\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n\n  @@unique(fields: [address, userEmail])\n}\n",
  "inlineSchemaHash": "8753635f390c207d61d89c6e5da467f2fb2738524a09f1e5a5f7b0f40d2b9872",
  "copyEngine": true
}
